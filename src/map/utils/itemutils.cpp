                    ...
                    if (PItem->isType(ITEM_WEAPON))
                    {
                        ...
                        switch (((CItemWeapon*)PItem)->getSkillType())
                        {
                            ...
                            case SKILLTYPE::SKILL_DAGGER:
                                ((CItemEquipment*)PItem)->addModifier(CModifier(Mod::CRITHITRATE_SLOT, 10));
                                break;
                            case SKILLTYPE::SKILL_HAND_TO_HAND:
                                ((CItemEquipment*)PItem)->addModifier(CModifier(Mod::CRITHITRATE_SLOT, 7));
                                break;
                            ...
                            case SKILLTYPE::SKILL_STAFF:
                                ((CItemEquipment*)PItem)->addModifier(CModifier(Mod::CRITHITDMG_SLOT, 10));
                                break;
                            case SKILLTYPE::SKILL_POLEARM:
                                ((CItemEquipment*)PItem)->addModifier(CModifier(Mod::CRITHITDMG_SLOT, 7));
                                break;
                            case SKILLTYPE::SKILL_GREAT_SWORD:
                                ((CItemEquipment*)PItem)->addModifier(CModifier(Mod::CRITHITDMG_SLOT, 5));
                                break;
