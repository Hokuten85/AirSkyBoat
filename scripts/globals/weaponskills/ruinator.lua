...
weaponskillObject.onUseWeaponSkill = function(player, target, wsID, tp, primary, action, taChar)
    local params = {}
    params.numHits = 4
    params.ftp100 = 1.6 params.ftp200 = 1.75 params.ftp300 = 2.00
    params.str_wsc = 0.7 + player:getMerit(xi.merit.RUINATOR) * 0.03 params.dex_wsc = 0.0 params.vit_wsc = 0.0
    ...
    params.atk100 = 1.2 params.atk200 = 1.25 params.atk300 = 1.3
