...
weaponskillObject.onUseWeaponSkill = function(player, target, wsID, tp, primary, action, taChar)
    ...
    params.agi_wsc = 0.0 params.int_wsc = 0.0 params.mnd_wsc = 0.35
    params.chr_wsc = 0.0
    ...
    params.acc100 = 1.1 params.acc200 = 1.25 params.acc300 = 1.5 -- TODO: verify -- "Accuracy varies with TP" in retail. All current evidence points to that this modifier is static values, not percentages.
