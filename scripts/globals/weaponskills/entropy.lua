...
weaponskillObject.onUseWeaponSkill = function(player, target, wsID, tp, primary, action, taChar)
    local params = {}
    params.numHits = 4
    params.ftp100 = 1.25 params.ftp200 = 1.5 params.ftp300 = 2.0
    params.str_wsc = 0.35 + player:getMerit(xi.merit.ENTROPY) * 0.015 
	params.dex_wsc = 0.0 params.vit_wsc = 0.0
    params.agi_wsc = 0.0 
	params.int_wsc = 0.35 + player:getMerit(xi.merit.ENTROPY) * 0.015
	params.mnd_wsc = 0.0
    params.chr_wsc = 0.0
