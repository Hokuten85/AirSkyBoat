...
-- Structure:            [spellId] = { Tier, Main_Effect, Spell_Level, Base_Power, Base_Duration, Composure, Always_Overwrite, Tick_Seconds },
    ...
    -- Protect / Protectra
    [xi.magic.spell.PROTECT      ] = { 1, xi.effect.PROTECT,        7,   10, 3600, false, false, 0 },
    [xi.magic.spell.PROTECT_II   ] = { 2, xi.effect.PROTECT,       27,   25, 3600, false, false, 0 },
    [xi.magic.spell.PROTECT_III  ] = { 3, xi.effect.PROTECT,       47,   40, 3600, false, false, 0 },
    [xi.magic.spell.PROTECT_IV   ] = { 4, xi.effect.PROTECT,       63,   55, 3600, false, false, 0 },
    [xi.magic.spell.PROTECT_V    ] = { 5, xi.effect.PROTECT,       76,   60, 3600, false, false, 0 },
    [xi.magic.spell.PROTECTRA    ] = { 1, xi.effect.PROTECT,        7,   10, 3600, false, false, 0 },
    [xi.magic.spell.PROTECTRA_II ] = { 2, xi.effect.PROTECT,       27,   25, 3600, false, false, 0 },
    [xi.magic.spell.PROTECTRA_III] = { 3, xi.effect.PROTECT,       47,   40, 3600, false, false, 0 },
    [xi.magic.spell.PROTECTRA_IV ] = { 4, xi.effect.PROTECT,       63,   55, 3600, false, false, 0 },
    [xi.magic.spell.PROTECTRA_V  ] = { 5, xi.effect.PROTECT,       75,   60, 3600, false, false, 0 },

    -- Refresh
    [xi.magic.spell.REFRESH      ] = { 1, xi.effect.REFRESH,       41,    3,  210, true,  true,  0 },
    [xi.magic.spell.REFRESH_II   ] = { 2, xi.effect.REFRESH,       82,    6,  210, true,  true,  0 },
    [xi.magic.spell.REFRESH_III  ] = { 3, xi.effect.REFRESH,       99,    9,  210, true,  true,  0 },

    -- Regen
    [xi.magic.spell.REGEN        ] = { 1, xi.effect.REGEN,         21,    5,  150, true,  false, 0 },
    [xi.magic.spell.REGEN_II     ] = { 2, xi.effect.REGEN,         44,   12,  150, true,  false, 0 },
    [xi.magic.spell.REGEN_III    ] = { 3, xi.effect.REGEN,         66,   20,  150, true,  false, 0 },
    [xi.magic.spell.REGEN_IV     ] = { 4, xi.effect.REGEN,         86,   30,  150, true,  false, 0 },
    [xi.magic.spell.REGEN_V      ] = { 5, xi.effect.REGEN,         99,   40,  150, true,  false, 0 },

    -- Shell / Shellra
    [xi.magic.spell.SHELL        ] = { 1, xi.effect.SHELL,         18,  980, 3600, false, false, 0 },
    [xi.magic.spell.SHELL_II     ] = { 2, xi.effect.SHELL,         37, 1480, 3600, false, false, 0 },
    [xi.magic.spell.SHELL_III    ] = { 3, xi.effect.SHELL,         57, 1990, 3600, false, false, 0 },
    [xi.magic.spell.SHELL_IV     ] = { 4, xi.effect.SHELL,         68, 2340, 3600, false, false, 0 },
    [xi.magic.spell.SHELL_V      ] = { 5, xi.effect.SHELL,         76, 2930, 3600, false, false, 0 },
    [xi.magic.spell.SHELLRA      ] = { 1, xi.effect.SHELL,         18,  980, 3600, false, false, 0 },
    [xi.magic.spell.SHELLRA_II   ] = { 2, xi.effect.SHELL,         37, 1480, 3600, false, false, 0 },
    [xi.magic.spell.SHELLRA_III  ] = { 3, xi.effect.SHELL,         57, 1990, 3600, false, false, 0 },
    [xi.magic.spell.SHELLRA_IV   ] = { 4, xi.effect.SHELL,         68, 2340, 3600, false, false, 0 },
    [xi.magic.spell.SHELLRA_V    ] = { 5, xi.effect.SHELL,         75, 2930, 3600, false, false, 0 },
...
xi.spells.enhancing.calculateEnhancingDuration = function(caster, target, spell, spellId, spellGroup, spellEffect)
    ...
    then
        duration = xi.magic.calculateDuration(math.random(300, 310), spell:getSkillType(), spell:getSpellGroup(), caster, target)
