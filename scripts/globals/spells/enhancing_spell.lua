...
-- Structure:            [spellId] = { Tier, Main_Effect, Spell_Level, Base_Power, Base_Duration, Composure, Always_Overwrite, Tick_Seconds },
    ...
    -- Regen
    [xi.magic.spell.REGEN        ] = { 1, xi.effect.REGEN,         21,    5,  180, true,  false, 0 },
    [xi.magic.spell.REGEN_II     ] = { 2, xi.effect.REGEN,         44,   12,  180, true,  false, 0 },
    [xi.magic.spell.REGEN_III    ] = { 3, xi.effect.REGEN,         66,   20,  180, true,  false, 0 },
    [xi.magic.spell.REGEN_IV     ] = { 4, xi.effect.REGEN,         86,   30,  180, true,  false, 0 },
    [xi.magic.spell.REGEN_V      ] = { 5, xi.effect.REGEN,         99,   40,  180, true,  false, 0 },
