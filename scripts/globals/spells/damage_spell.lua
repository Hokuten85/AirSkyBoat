...
-- Structure:           [spellId] = {  Stat used, vNPC,    M,  vPC,   I }, -- Inflexion point unknown and not used ATM. Set to 100, 250 and 400, for now.
    [xi.magic.spell.DOTON_ICHI  ] = { xi.mod.INT,   45,  0.5,   45, 100 },
    [xi.magic.spell.DOTON_NI    ] = { xi.mod.INT,   90,    1,   90, 250 },
    [xi.magic.spell.DOTON_SAN   ] = { xi.mod.INT,  180,  1.5,  180, 400 },
    [xi.magic.spell.HUTON_ICHI  ] = { xi.mod.INT,   45,  0.5,   45, 100 },
    [xi.magic.spell.HUTON_NI    ] = { xi.mod.INT,   90,    1,   90, 250 },
    [xi.magic.spell.HUTON_SAN   ] = { xi.mod.INT,  180,  1.5,  180, 400 },
    [xi.magic.spell.HYOTON_ICHI ] = { xi.mod.INT,   45,  0.5,   45, 100 },
    [xi.magic.spell.HYOTON_NI   ] = { xi.mod.INT,   90,    1,   90, 250 },
    [xi.magic.spell.HYOTON_SAN  ] = { xi.mod.INT,  180,  1.5,  180, 400 },
    [xi.magic.spell.KATON_ICHI  ] = { xi.mod.INT,   45,  0.5,   45, 100 },
    [xi.magic.spell.KATON_NI    ] = { xi.mod.INT,   90,    1,   90, 250 },
    [xi.magic.spell.KATON_SAN   ] = { xi.mod.INT,  180,  1.5,  180, 400 },
    [xi.magic.spell.RAITON_ICHI ] = { xi.mod.INT,   45,  0.5,   45, 100 },
    [xi.magic.spell.RAITON_NI   ] = { xi.mod.INT,   90,    1,   90, 250 },
    [xi.magic.spell.RAITON_SAN  ] = { xi.mod.INT,  180,  1.5,  180, 400 },
    [xi.magic.spell.SUITON_ICHI ] = { xi.mod.INT,   45,  0.5,   45, 100 },
    [xi.magic.spell.SUITON_NI   ] = { xi.mod.INT,   90,    1,   90, 250 },
    [xi.magic.spell.SUITON_SAN  ] = { xi.mod.INT,  180,  1.5,  180, 400 },
