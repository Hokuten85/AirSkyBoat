select * from (
SELECT p.itemid, ib.name, sell01, 0 as buy01, p.price, 30 as stock01, sell12, 0 as buy12, p.price12, 30 as stock12
...
UNION -- Ranged
SELECT pi2.itemid, ib.name, pi2.sell01, 0 as buy01, 1000 div ib.stackSize as price, 30 as stock01, sell12, 0 as buy12, 1000 as price12, 30 as stock12
FROM item_basic ib
...
UNION -- fish
SELECT pi2.itemid, ib.name, pi2.sell01, 0 as buy01, price, 30 as stock01, sell12, 0 as buy12, price12, 30 as stock12
FROM item_basic ib
inner join pydarkstar_items pi2 
	on ib.itemid = pi2.itemid 
where ah = 51
