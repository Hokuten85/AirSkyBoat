...
UPDATE spell_list SET jobs = 0x0000000000000000000000000000004B000000000000 WHERE skill = 43 AND CAST(CONV(SUBSTR(HEX(sl.jobs),31,2),16,10) AS INT) BETWEEN 75 AND 85; -- Reduce level of blue spells 76-85 to 75
